  ...
  static List<PermissionSpec> getPermissions({required String brand}) {
    ...
    final basePermissions = [
      PermissionSpec(
        ...
        iconWidth: 32.0,
        iconHeight: 32.0,
        name: 'Floating Window Permission',
      ...
      PermissionSpec(
        ...
        iconWidth: 32.0,
        iconHeight: 32.0,
        name: 'Allow Background Run',
        description: 'Continues running in background, service not interrupted when app is switched',
      ...
      PermissionSpec(
        ...
        description: 'Persistent auto-operation, easily complete complex tasks',
