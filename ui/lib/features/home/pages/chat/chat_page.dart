...
class _ChatPageState extends State<ChatPage>
  ...
  String _buildDefaultOpenClawDeployConfigJson({
    ...
    final config = <String, dynamic>{
      ...
      'models': {
        ...
        'providers': {
          providerId: {
            ...
            'apiKey': _openClawProviderApiKeyEnv,
            'models': [
              {
                'id': modelId,
                'name': modelId,
      ...
      'gateway': {
        ...
        'bind': 'loopback',
        'port': 18789,
        'auth': {'mode': 'token', 'token': _openClawGatewayTokenEnvRef},
      },
    };
  ...
  String? _validateOpenClawDeployConfig(String configJson) {
    ...
    if (tokenValue != _openClawGatewayTokenEnvRef) {
      return 'gateway.auth.token 必须保持为 $_openClawGatewayTokenEnvRef';
    }
    return null;
  }
