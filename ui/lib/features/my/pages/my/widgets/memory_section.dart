...
class MemorySummaryClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.cubicTo(
      152, 0,
      154, tabHeight,
      tabStartX + tabTopWidth, tabHeight,
    );
    ...
    // 右上角圆角过渡
    path.cubicTo(
      size.width - cornerRadius, tabHeight,
      size.width, tabHeight + 2.156,
      size.width, tabHeight + cornerRadius,
    );
                      ...
                      ? Column(
                          ...
                          children: [
                            ...
                            _buildShimmerPlaceholder(
                              width: 180,
                              height: 14,
                              animation: widget.animationController ?? AlwaysStoppedAnimation(0.5),
